...
const defaultAffairs: AffairType[] = [ // need to fix any
    {_id: 1, name: 'Girlfriend', priority: 'high'}, // студенты могут изменить содержимое name и количество элементов в массиве, ...priority не менять!
    {_id: 2, name: 'gym', priority: 'low'},
    {_id: 3, name: 'work', priority: 'low'},
    {_id: 4, name: 'Studying', priority: 'high'},
    {_id: 5, name: 'business', priority: 'middle'},
]
...
function HW2() {
    ...
    return (
        <div id={'hw2'}>
            <div className={s2.hwTitle}>Olegter</div>
            <div className={s2.hw}>
                <Affairs
